...
print(D3M$Delayed_O[52]) # Result: 21.7226
print(D3M$Delayed_P1[52]) # Result: 0
print(D3M$Delayed_P2[52]) # Result: 59.56661
print(D3M$Delayed_P3[52]) # Result: 515.4551
...
write_xlsx(D3M, "D3M_Solution_1st_Approach_A.xlsx")
